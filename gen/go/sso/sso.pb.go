...
type LoginRequest struct {
	...
	AppId    int32  `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` // ID of the app to logon to
}
...
type LoginResponse struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // Auth token of the loginned user
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x5a, 0x11, 0x73, 0x68, 0x61, 0x6c, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b, 0x73, 0x73,
